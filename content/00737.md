...
However, when creating a Supply Chain from scratch, it is necessary to define the components that make up the Supply Chain like below
...
You may not like the procedure of updating the TAP by running the below commands after installing TAP as it is not declarative installation of TAP.
